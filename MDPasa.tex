...
banda base. En particular para la detecci\'on, el objetivo es identificar el s\'imbolo enviado, para cual no hace
falta demodular fielmente la onda anal\'ogica intermedia de banda base.
...
Las siguientes figuras muestran ejemplos de este tipo, en comparaci\'on con el caso de banda base.
...
que $x_c$ depende linealmente de los s\'imbolos; en el caso de FSK la dependencia es no lineal.
