...
\begin{figure}[htb]
    ...
    \begin{blockdiagram}
        ...
        \draw [-stealth] (inicio) -- (sum);
        \draw [-stealth] (p) -- (sum);
        \draw [-stealth] (sum) -- (filtro);
        \draw [-stealth] (filtro) -- (det);
        \draw [-stealth] (det) -- (delim);
    \end{blockdiagram}
    \endpgfgraphicnamed
\end{figure}
...
\begin{itemize}
    ...
    \begin{center}
        ...
        \begin{blockdiagram}
            ...
            \draw (inicio) -- (p);
            \draw [-stealth] (p) |- (pasa1);
            \draw [-stealth] (pasa1) -- (det1);
            \draw [-stealth]  (det1) -| (sum);
            \draw [-stealth] (p) |- (pasa2);
            \draw [-stealth] (pasa2) -- (det2);
            \draw [-stealth]  (det2) -| (sum);
...
\begin{center}
   \resizebox{\textwidth}{!}{
    ...
    \begin{blockdiagram}
        ...
        \draw [-stealth] (inicio) -- (pasa1);
        \draw [-stealth] (pasa1) -- (p) -- (mult);
        \draw [-stealth] (p) |- (ret);
        \draw [-stealth] (ret) -| (mult);
        \draw [-stealth] (mult) -- (pasa2);
        \draw [-stealth] (pasa2) -- (comp);
    \end{blockdiagram}
    \endpgfgraphicnamed}
\end{center}
%\end{figure}
