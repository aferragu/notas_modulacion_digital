...
\begin{minipage}{0.3\textwidth}La función de distribución de una V.A. se define como $F_X(x)=\p{X\leq x}$\end{minipage}\hfill
...
\[F_{X_1,\ldots,X_n}(x_1,x_2,\ldots,x_n)=\p{X_1\leq x_1,\ldots, X_n\leq x_n}.\]
