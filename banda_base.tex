...
\begin{minipage}{0.3\textwidth}
    Simetría vestigial respecto a $\frac{f_s}{2}$
\end{minipage}
\begin{minipage}{0.5\textwidth}
    \resizebox{\textwidth}{!}{
...
En cuanto a la eficiencia espectral, hemos aumentado el ancho de banda, por lo cual la eficiencia baja. En particular:
\begin{equation*}
