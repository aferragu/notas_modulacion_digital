...
un retardo aleatorio en la onda PAM, y también para obtener (\ref{eq:dep}) de la modualación DSB se incluía una fase aleatoria.
...
Recordemos que ésta tiene densidad espectral de potencia $S_x(f)
