...
Consideremos que este ruido aleatorio tiene una densidad $f_N(n)$, es decir, $\p{a\leqslant n_k \leqslant b} = \int_a^b f_N(n)dn$ tal que:
\begin{align*}
