...
\begin{figure}[htb]
    ...
    \begin{blockdiagram}
        ...
        \draw [-stealth] (inicio) -- (modD);
        \draw [-stealth] (modD) -- node [below=12mm] {$\sum a_k p(t-kT_s)$} (modA);
        \draw [-stealth] (modA) -| (canal);
        \draw [-stealth] (canal) |- (detA);
        \draw [-stealth] (detA) -- (detD);
        \draw [-stealth] (detD) -- (salida);
    \end{blockdiagram}
