...
\section{Modulación pasabanda $M$-aria}\label{sec:modulacion pasabanda m aria}
...
\section{Detección coherente para la modulación pasabanda lineal}\label{sec:deteccion coherente}
